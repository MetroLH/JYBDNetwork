...
@implementation JSRefreshRequestErrorView
...
- (void)layoutSubviews {
    ...
    self.tipButton.frame = CGRectMake((self.frame.size.width - 100)/2, self.tipLabel.frame.origin.y + self.tipLabel.frame.size.height + 30, 100, 30);
}
